Map<String, Map<String, String>> translations = {
  ...
  'no_orders': {
    'fr': 'Aucune commande passée.',
    'en': 'No orders placed.',
    'ar': 'لا توجد طلبات',
  },
  'status_inconnu': {'fr': 'Inconnu', 'en': 'Unknown', 'ar': 'غير معروف'},
  ...
  'your_order': {'fr': 'Votre commande', 'en': 'Your order', 'ar': 'طلبك'},
  'status_pending': {'fr': 'Envoyée', 'en': 'Sent', 'ar': 'تم الإرسال'},
  'status_approved': {
    'fr': 'Approuvée',
    'en': 'Approved',
    'ar': 'تمت الموافقة',
  ...
  'status_completed': {'fr': 'Livrée', 'en': 'Delivered', 'ar': 'تم التوصيل'},
  'order_details_title': {
    'fr': 'Détails de la commande',
    'en': 'Order Details',
    'ar': 'تفاصيل الطلب',
  },
  'your_delivery_person': {
    'fr': 'Votre livreur',
    'en': 'Your courier',
  ...
  'cmbk_offer':{
    ...
    'en': 'Come back soon to discover our promotions!',
    'ar': 'عد إلينا قريباً لاكتشاف عروضنا الترويجية!',
  },
  'no_offer':{
    'fr': 'Aucune offre pour le moment',
    'en': 'No offers at the moment',
    'ar': 'لا توجد عروض في الوقت الحالي',
  },
  'currency':{
    'fr': 'Dinar',
    'en': 'Dinar',
  ...
  'specialty': {'fr': 'Spécialité', 'en': 'Specialty', 'ar': 'التخصص'},
  'submit_application': {
  ...
  'instagram': {'fr': 'Instagram', 'en': 'Instagram', 'ar': 'انستغرام'},
